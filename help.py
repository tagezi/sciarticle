...
import var
from strmain import get_filename_patch


sLangFromFile = get_filename_patch(var.files_dir, var.lang_file)
sLangVariants = get_filename_patch(var.files_dir, var.lang_var_file)
sLangToFile = get_filename_patch(var.files_dir, var.lang_backup)
sLangVarToFile = get_filename_patch(var.files_dir, var.lang_var_backup)
